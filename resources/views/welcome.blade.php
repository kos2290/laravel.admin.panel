                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        ...
                        @elseif(Auth::user()->isUser())
                            <strong>
                                <a href="{{ url('/user/index') }}" class="text-sm text-gray-700 underline">
                                    Кабинет
                                </a>
                            </strong>
                            <strong>
                        ...
                        @elseif(Auth::user()->isAdministrator())
                            <strong>
                                <a href="{{ url('/admin/index') }}" class="text-sm text-gray-700 underline">
                        ...
                        <strong>
                            <a class="dropdown-item" href="{{ route('logout') }}" class="text-sm text-gray-700 underline"
                                onclick="
